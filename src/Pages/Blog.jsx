      ...
      <div className="bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Le Blog Juridique d'ALT</h2>
            <p className="mt-2 text-lg leading-8 text-gray-600">
            Explorez nos articles pour des analyses, conseils pratiques et actualités juridiques. Plongez dans des contenus enrichissants pour rester informé des évolutions du droit.
            </p>
          </div>
